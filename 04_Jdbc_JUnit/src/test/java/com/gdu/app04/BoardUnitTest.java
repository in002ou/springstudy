 ...
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)	// 메소드명의 알파벳 순으로 테스트를 수행.
public class BoardUnitTest {
	...
	@Test
	public void a1삽입테스트() {
		BoardDTO board = new BoardDTO(0, "제목", "ㄴㅇ", "ㅈㅅㅈ", null, null);
...
//		System.out.println("a2 - " + board);	// LOG기능으로 대체할 예정
	...
	@Test
	public void a3수정테스트() {
		BoardDTO board = new BoardDTO(1, "[ㅅㅈ]제목", "[ㅅㅈ]ㄴㅇ", null, null, null);
...
//		System.out.println("a5 - " + list);	// LOG기능으로 대체할 예정
	...
	@Test
	public void a6삭제테스트() {
		int board_no = 1;	// 삭제할 게시글의 번호
		assertEquals(1, boardDAO.deleteBoard(board_no));	// boardDAO.deleteBoard(board_no)가 1이면 테스트 성공
	}
}
