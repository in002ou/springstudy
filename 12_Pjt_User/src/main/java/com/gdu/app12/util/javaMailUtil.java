...
public class javaMailUtil {
	...
	public void sendJavaMail(String to, String title, String content) {		// 받는 사람, 제목, 내
		try {
			...
			properties.put("mail.smtp.auth", env.getProperty("spring.mail.properties.mail.stmp.auth"));
			properties.put("mail.stmp.starttls.enable", env.getProperty("spring.mail.properties.mail.smtp.starttls.enable"));
