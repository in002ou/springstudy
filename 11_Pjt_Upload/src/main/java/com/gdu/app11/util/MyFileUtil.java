...
public class MyFileUtil {
	...
	public String getTempPath() {
		return "/Users/choein-yeong/Documents/storage" + sep + "temp";
	}
	...
	public String getYesterdayPath() {
		...
		date.minusDays(1);
		return "/Users/choein-yeong/Documents/storage"+ sep + date.getYear() + sep + String.format("%02d", date.getMonthValue()) + sep + String.format("%02d", date.getDayOfMonth());
	}
